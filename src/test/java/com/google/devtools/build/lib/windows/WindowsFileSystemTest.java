...
public class WindowsFileSystemTest {
  ...
  public void testIsJunction() throws Exception {
    ...
    assertThat(fs.getPath("c:\\src\\bazel\\build-rel-sym").isSymbolicLink()).isTrue();
    assertThat(fs.getPath("c:\\src\\bazel\\build-rel-sym").isFile()).isTrue();
    assertThat(fs.getPath("c:\\src\\bazel\\build-rel-sym").isDirectory()).isFalse();

    assertThat(fs.getPath("c:\\src\\bazel\\build-abs-sym").isSymbolicLink()).isTrue();
    assertThat(fs.getPath("c:\\src\\bazel\\build-abs-sym").isFile()).isTrue();
    assertThat(fs.getPath("c:\\src\\bazel\\build-abs-sym").isDirectory()).isFalse();

    assertThat(fs.getPath("c:\\src\\bazel\\build").isSymbolicLink()).isFalse();
    assertThat(fs.getPath("c:\\src\\bazel\\build").isFile()).isTrue();
    assertThat(fs.getPath("c:\\src\\bazel\\build").isDirectory()).isFalse();

    assertThat(fs.getPath("c:\\src\\bazel\\src-rel-sym").isSymbolicLink()).isTrue();
    assertThat(fs.getPath("c:\\src\\bazel\\src-rel-sym").isFile()).isFalse();
    assertThat(fs.getPath("c:\\src\\bazel\\src-rel-sym").isDirectory()).isTrue();

    assertThat(fs.getPath("c:\\src\\bazel\\src-abs-sym").isSymbolicLink()).isTrue();
    assertThat(fs.getPath("c:\\src\\bazel\\src-abs-sym").isFile()).isFalse();
    assertThat(fs.getPath("c:\\src\\bazel\\src-abs-sym").isDirectory()).isTrue();

    assertThat(fs.getPath("c:\\src\\bazel\\src-junc").isSymbolicLink()).isTrue();
    assertThat(fs.getPath("c:\\src\\bazel\\src-junc").isFile()).isFalse();
    assertThat(fs.getPath("c:\\src\\bazel\\src-junc").isDirectory()).isTrue();

    assertThat(fs.getPath("c:\\src\\bazel\\src").isSymbolicLink()).isFalse();
    assertThat(fs.getPath("c:\\src\\bazel\\src").isFile()).isFalse();
    assertThat(fs.getPath("c:\\src\\bazel\\src").isDirectory()).isTrue();
  }
